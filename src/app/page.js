  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-2 md:grid-cols-2 md:gap-4 xl:grid-cols-4 2xl:gap-6 mt-2">
        <div className=" rounded border border-stroke bg-white px-7.5 py-6 dark:border-strokedark dark:bg-boxdark group hover:bg-primary hover:text-white hover:scale-105 duration-150">
