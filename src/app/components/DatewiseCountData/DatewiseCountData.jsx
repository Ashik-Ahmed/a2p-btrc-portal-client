    ...
    return (
        <div>
            <div className='px-4 py-2 my-2 bg-white rounded'>
                ...
                <form onSubmit={handleSubmit(getDatewiseCount)} className='mt-8 flex gap-x-2'>
                    ...
                    <Button type='submit' label='Search' loading={loading} className="bg-sky-500 text-white p-2 rounded" />
            ...
            <div className='px-4 py-2 bg-white rounded shadow-md'>
                ...
                <DataTable value={reportData} size="small" paginator rows={10} rowsPerPageOptions={[5, 10, 25, 50]}
                    ...
                    <Column field="sms_count" header="SMS Count" />
                </DataTable>
            </div>
        </div >
    );
